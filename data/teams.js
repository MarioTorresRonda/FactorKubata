...
import secreto from "@/public/teams/SCRT.png";
...
import taxers from "@/public/teams/Taxers.jpg";
...
export const teams = {
    ...
    TAX: {
        ...
        icon: taxers,        
        players: {
            top : { name : "eguirado4", puuid: ""  },
            jungle : { name : "Henriixx", puuid: "" },
            mid : { name : "WIZARD", puuid: "" },
            midSub : { name : "MoNkEy D GeEkEr", puuid: "" },
            adc : { name : "TAX Galvany", puuid: "" },
            supp : { name : "DanielRN", puuid: "" },
        }
